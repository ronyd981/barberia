...
const Menu = () => {
  return (
    <div className="flex items-center justify-center bg-black shadow-md p-8 lg:p-12 text-white">
      <h2 className="font-windsong text-4xl leading-3 lg:text-6xl">Welcome</h2>
    </div>
  );
};
